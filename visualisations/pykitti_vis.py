...
basedir = '/media/menonsandu/Chest/Ubuntu/Downloads/kitti/data_odometry_gray/dataset'
...
xyz = np.array([pose[:,3:].flatten()[:3] for pose in dataset.poses])
f2 = plt.figure()
ax2 = f2.add_subplot(111, projection='3d')
ax2.set_xlabel('x ')
ax2.set_ylabel('y ')
ax2.set_zlabel('z ')
ax2.plot(xyz[:,0],xyz[:,1],xyz[:,2], label='IMU', color='blue')

ax2.set_title('XYZ trajectory')
