...
def construct_transformation_matrix(rotation_matrix, translation_vector):
    # print(rotation_matrix, translation_vector)
    transformation_matrix = np.hstack((rotation_matrix, np.array([translation_vector]).T))
